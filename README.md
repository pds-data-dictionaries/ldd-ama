# Atmospheres Modeling Annex (AMA) Local Data Dictionary (LDD)



The AMA dictionary provides a set of attributes for use in Atmospheres Modeling Annex External Products.
